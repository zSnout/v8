...
import type { Lexer, Rules } from "moo"
...
function compile(rules: Rules): Lexer {
...
export { compile }
export const states: typeof import("moo").states = compileStates
export const error: typeof import("moo").error = Object.freeze({ error: true })
export const fallback: typeof import("moo").fallback = Object.freeze({
  fallback: true,
})
export const keywords: typeof import("moo").keywords = keywordTransform
