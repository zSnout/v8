...
export function PlainFieldList<T extends { id: Id; name: string }>(props: {
  ...
  return (
    <div
      class="flex min-h-48 flex-col overflow-x-clip overflow-y-scroll rounded-lg border border-z pb-8"
      classList={{
  ...
  function Item(props: { item: T; index: number | null }) {
    return (
      <div
        class="-mx-px -mt-px flex items-center border border-z px-2"
        classList={{
